...
const desktopInfo = Object.freeze({
  ...
  batchImport: Object.freeze({
    ...
    saveReviewEdits: payload => ipcRenderer.invoke('nbme:batch-import:save-review-edits', payload),
    ...
    beginReviewSurvivorImport: payload => ipcRenderer.invoke('nbme:batch-import:begin-review-survivor-import', payload),
    finishReviewSurvivorImport: payload => ipcRenderer.invoke('nbme:batch-import:finish-review-survivor-import', payload),
    ...
    pauseJob: payload => ipcRenderer.invoke('nbme:batch-import:pause-job', payload),
    resumeJob: payload => ipcRenderer.invoke('nbme:batch-import:resume-job', payload),
