...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-type", required=True, choices=["amboss_pdf", "nbme_pdf", "anki_notes", "fast_facts_pptx", "emma_holiday_pdf", "mehlman_pdf", "ome_pdf", "images_tables_source"])
