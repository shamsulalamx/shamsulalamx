...
const Results = (() => {
  ...
  function renderReviewQuestion() {
    ...
    // Always show explanations in review
    ...
    q.o.forEach(opt => {
      ...
      div.innerHTML = `
        <div class="exp-header">
          ...
          ${isCorrect ? '<span class="exp-badge-correct">✓ Correct</span>' : ''}
          ${isChosen && !isCorrect ? '<span class="exp-badge-wrong">✗ Your Answer</span>' : ''}
        </div>
  ...
  function saveEditQuestion() {
    ...
    if (Quiz.getState()) Quiz.renderQuestion();
  }
  ...
  return { show, openReview, reviewPrev, reviewNext, closeReview, toggleFlagReview, openEditQuestion, saveEditQuestion };
})();
