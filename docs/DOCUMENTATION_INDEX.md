...
Current runtime safety baseline: `v4.40-phase10c-survivability-stable`. Current development head: `v4.48-lecture-explanation-tables-stable`. Current docs should describe the Batch Import queue system as the Phase 10C survivability system, reconciliation as filesystem-first plus queue/history merge, and runtime safety layer as process registry plus cleanup system.
